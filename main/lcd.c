...
IRAM_ATTR static bool rgb_lcd_on_vsync_event(__attribute((__unused__)) esp_lcd_panel_handle_t panel, __attribute((__unused__)) const esp_lcd_rgb_panel_event_data_t *edata, __attribute((__unused__)) void *user_ctx)
{
...
void initLcd()
{
    ...
    esp_io_expander_set_dir(io_expander, IO_EXPANDER_PIN_NUM_5 | IO_EXPANDER_PIN_NUM_0 | IO_EXPANDER_PIN_NUM_2 | IO_EXPANDER_PIN_NUM_1,
                            IO_EXPANDER_OUTPUT);
...
//    vTaskDelay(pdMS_TO_TICKS(200));
    esp_io_expander_set_level(io_expander, IO_EXPANDER_PIN_NUM_1, 1); // BL Control
    esp_io_expander_set_level(io_expander, IO_EXPANDER_PIN_NUM_5, 0);
    esp_io_expander_set_level(io_expander, IO_EXPANDER_PIN_NUM_0, 1); // TP Reset
    esp_io_expander_set_level(io_expander, IO_EXPANDER_PIN_NUM_2, 1); // Display reset
    ...
    const esp_lcd_touch_config_t tp_cfg = {
        ...
        .rst_gpio_num = (gpio_num_t) EXAMPLE_PIN_NUM_TOUCH_RST,
